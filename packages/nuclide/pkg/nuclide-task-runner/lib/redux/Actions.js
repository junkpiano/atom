 ...
 * @format
 */
const DID_ACTIVATE_INITIAL_PACKAGES = 'DID_ACTIVATE_INITIAL_PACKAGES';
exports.DID_ACTIVATE_INITIAL_PACKAGES = DID_ACTIVATE_INITIAL_PACKAGES;
const REGISTER_TASK_RUNNER = 'REGISTER_TASK_RUNNER';
exports.REGISTER_TASK_RUNNER = REGISTER_TASK_RUNNER;
const REQUEST_TOGGLE_TOOLBAR_VISIBILITY = 'REQUEST_TOGGLE_TOOLBAR_VISIBILITY';
exports.REQUEST_TOGGLE_TOOLBAR_VISIBILITY = REQUEST_TOGGLE_TOOLBAR_VISIBILITY;
const RUN_TASK = 'RUN_TASK';
exports.RUN_TASK = RUN_TASK;
const SELECT_TASK_RUNNER = 'SELECT_TASK_RUNNER';
exports.SELECT_TASK_RUNNER = SELECT_TASK_RUNNER;
const SET_STATE_FOR_TASK_RUNNER = 'SET_STATE_FOR_TASK_RUNNER';
exports.SET_STATE_FOR_TASK_RUNNER = SET_STATE_FOR_TASK_RUNNER;
const SET_STATES_FOR_TASK_RUNNERS = 'SET_STATES_FOR_TASK_RUNNERS';
exports.SET_STATES_FOR_TASK_RUNNERS = SET_STATES_FOR_TASK_RUNNERS;
const SET_PROJECT_ROOT = 'SET_PROJECT_ROOT';
exports.SET_PROJECT_ROOT = SET_PROJECT_ROOT;
const SET_CONSOLE_SERVICE = 'SET_CONSOLE_SERVICE';
exports.SET_CONSOLE_SERVICE = SET_CONSOLE_SERVICE;
const SET_CONSOLES_FOR_TASK_RUNNERS = 'SET_CONSOLES_FOR_TASK_RUNNERS';
exports.SET_CONSOLES_FOR_TASK_RUNNERS = SET_CONSOLES_FOR_TASK_RUNNERS;
const ADD_CONSOLE_FOR_TASK_RUNNER = 'ADD_CONSOLE_FOR_TASK_RUNNER';
exports.ADD_CONSOLE_FOR_TASK_RUNNER = ADD_CONSOLE_FOR_TASK_RUNNER;
const REMOVE_CONSOLE_FOR_TASK_RUNNER = 'REMOVE_CONSOLE_FOR_TASK_RUNNER';
exports.REMOVE_CONSOLE_FOR_TASK_RUNNER = REMOVE_CONSOLE_FOR_TASK_RUNNER;
const SET_TOOLBAR_VISIBILITY = 'SET_TOOLBAR_VISIBILITY';
exports.SET_TOOLBAR_VISIBILITY = SET_TOOLBAR_VISIBILITY;
const STOP_TASK = 'STOP_TASK';
exports.STOP_TASK = STOP_TASK;
const TASKS_READY = 'TASKS_READY';
exports.TASKS_READY = TASKS_READY;
...
const TASK_STOPPED = 'TASK_STOPPED';
exports.TASK_STOPPED = TASK_STOPPED;
const TASK_ERRORED = 'TASK_ERRORED';
exports.TASK_ERRORED = TASK_ERRORED;
const TOGGLE_TOOLBAR_VISIBILITY = 'TOGGLE_TOOLBAR_VISIBILITY';
exports.TOGGLE_TOOLBAR_VISIBILITY = TOGGLE_TOOLBAR_VISIBILITY;
const UNREGISTER_TASK_RUNNER = 'UNREGISTER_TASK_RUNNER';
