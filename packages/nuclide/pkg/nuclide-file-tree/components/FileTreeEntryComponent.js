...
<<<<<<< HEAD
      ...
      const movableNodes = nodes.filter(node => FileTreeHgHelpers().isValidRename(node, this.props.node.uri));
      ...
      const nothingToMove = !(haveMovableNodes || haveUploadableOSFiles); // Ignores hover over invalid targets.
