...
class SuggestionListElement extends HTMLElement {
  ...
  attachedCallback() {
    _reactDom.default.render(React.createElement(SuggestionListComponent, {
...
const SuggestionListHTMLElement = document.registerElement('hyperclick-suggestion-list', {
